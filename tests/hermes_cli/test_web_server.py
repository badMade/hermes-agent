...
class TestPluginAPIAuth:
    ...
    def test_plugin_route_allows_auth(self):
        ...
        # Since this is an isolated test environment without actual loaded plugins,
        # we only care that the request passes the auth layer (returns != 401).
