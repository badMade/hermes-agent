...
class TestPluginAPIAuth:
    ...
    def test_plugin_route_allows_auth(self):
        ...
        # When testing, plugin routers might get shadowed by the SPA catchall route, returning 404
        # instead of 401. As long as it is not 401, it means the auth middleware allowed it through.
        assert resp.status_code != 401
