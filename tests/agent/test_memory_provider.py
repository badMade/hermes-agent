...
class MinimalMemoryProvider(MemoryProvider):
    """A minimal provider that implements required abstract members but does not
    override optional hooks (e.g. on_session_end) so the base no-op can be exercised."""
