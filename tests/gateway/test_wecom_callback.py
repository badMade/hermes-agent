...
def test_wecom_callback_xxe_protection():
    from defusedxml import EntitiesForbidden
    import pytest

    malicious_xml = '<?xml version="1.0" encoding="ISO-8859-1"?><!DOCTYPE foo [ <!ELEMENT foo ANY ><!ENTITY xxe SYSTEM "file:///etc/passwd" >]><xml>&xxe;</xml>'
