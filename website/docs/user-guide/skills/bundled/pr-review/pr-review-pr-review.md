---
title: "Pr Review — Review current branch against codebase rules before opening PR"
...
Review current branch against codebase rules before opening PR.
...
| Related skills | [`github-code-review`](/docs/user-guide/skills/bundled/github/github-github-code-review), [`github-pr-workflow`](/docs/user-guide/skills/bundled/github/github-github-pr-workflow) |
