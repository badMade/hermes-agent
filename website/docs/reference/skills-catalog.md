...
| Skill | Description | Path |
|-------|-------------|------|
| [`automated-pr-reviewer`](/docs/user-guide/skills/bundled/github/github-automated-pr-reviewer) | Automated PR reviewer: scans for standalone `@jules` comments and triggers static diff reviews. | `github/automated-pr-reviewer` |
