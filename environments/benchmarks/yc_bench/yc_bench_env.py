    ...
    async def evaluate(self, *args, **kwargs) -> None:
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    f"Error cleaning up environments during interruption: {e}",
                    exc_info=True,
                )
        ...
        try:
            ...
            logger.error(
                f"Error cleaning up environments during evaluation cleanup: {e}",
                exc_info=True,
            )
        ...
        try:
            ...
            logger.error(
                f"Error shutting down tool executor during evaluation cleanup: {e}",
                exc_info=True,
            )
