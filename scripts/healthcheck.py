...
def main() -> None:
    ...
    success &= run_cmd(["ruff", "check", "."], "ruff check", allow_failure=False)
    success &= run_cmd(["mypy", "--strict", "."], "mypy", allow_failure=False)
    success &= run_cmd(["pytest", "-q"], "pytest", allow_failure=False)
