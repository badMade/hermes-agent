...
The download requires cosign provenance verification of checksums.txt plus
SHA-256 archive verification.  Installation runs in a background thread so
...
def _install_tirith(*, log_failures: bool = True) -> tuple[str | None, str]:
    ...
    try:
        ...
        if not shutil.which("cosign"):
            log("tirith install aborted: cosign not found on PATH")
