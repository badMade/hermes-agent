...
class AIAgent:
    ...
    def __init__(
        ...
        self._subdirectory_hints = SubdirectoryHintTracker(
            working_dir=gateway.session_context.get_terminal_cwd() or None,
        )
    ...
    def _build_system_prompt_parts(self, system_message: str = None) -> Dict[str, str]:
        ...
        if not self.skip_context_files:
            ...
            import gateway.session_context
            _context_cwd = gateway.session_context.get_terminal_cwd() or None
            ...
            if function_name == "terminal" and self._checkpoint_mgr.enabled:
                try:
                    ...
                    if _is_destructive_command(cmd):
                        cwd = function_args.get("workdir") or gateway.session_context.get_terminal_cwd(os.getcwd())
