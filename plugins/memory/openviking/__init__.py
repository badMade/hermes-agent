...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def _tool_add_resource(self, args: dict) -> str:
        ...
        if source_path is not None or _is_local_path_reference(url):
            return tool_error("Local file and directory paths are not supported; provide a remote http(s), git, or ssh URL")
